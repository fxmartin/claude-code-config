---
name: roast
description: Use when the user wants a hard-nosed repository review focused on real
  bugs, risks, regressions, and maintainability problems rather than a generic code
  walkthrough.
short_description: Review the repo like a senior reviewer
invocation_examples:
- roast
- roast focus on security and shell scripts
- roast review the recent bootstrap changes
---
