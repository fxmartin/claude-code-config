---
name: coverage
description: Use when the user wants to assess test coverage, close meaningful gaps,
  and raise confidence with targeted tests and verification.
short_description: Improve test coverage pragmatically
invocation_examples:
- coverage
- coverage for bootstrap scripts
- coverage focus on lib/preflight.sh and related tests
---
