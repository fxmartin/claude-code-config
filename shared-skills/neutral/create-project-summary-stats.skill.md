...
description: Use when the user wants a dated project metrics snapshot assembled from
  repository, test, git, and GitHub signals.
short_description: Create a dated project metrics snapshot
invocation_examples:
- create-project-summary-stats
- create-project-summary-stats focus on testing and activity
---
