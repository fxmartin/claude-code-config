---
name: create-issue
description: Use when the user wants to investigate a defect report, check for duplicates,
  and create a high-signal GitHub issue with gh.
short_description: Investigate and file GitHub issues
invocation_examples:
- create-issue login page returns 500 after submitting valid credentials
- create-issue mobile layout overlaps on the settings page in Safari
---
...
10. **Generate issue title**:
    ...
    - Available labels are: api, backend, bench, blocked, breaking-change, bug, cartography, critical, database, deliverables, documentation, duplicate, enhancement, frontend, good first issue, help wanted, high, hotfix, in-progress, infra, ingestion, invalid, llm-pipeline, low, medium, needs-triage, performance, question, refactor, security, tech-debt, test, ux, validation, wontfix
