---
name: check-releases
description: Use when the user wants to run the repo's release-monitor workflow and
  summarize dependency, security, and upgrade signals.
short_description: Run and summarize release monitoring
invocation_examples:
- check-releases
- check-releases focus on security updates
---
