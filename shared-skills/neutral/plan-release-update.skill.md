...
description: Use when the user wants to read a release-monitor issue and produce an
  implementation plan for the update or migration work.
short_description: Plan implementation for a release issue
invocation_examples:
- plan-release-update 123
---
