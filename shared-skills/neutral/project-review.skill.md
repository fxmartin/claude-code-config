---
name: project-review
description: Use when the user wants a structured technical and business readiness
  review that results in a concise REVIEW.md.
short_description: Generate a structured project review
invocation_examples:
- project-review
- project-review focus on release readiness
- project-review focus on maintainability and risk
---
