...
**Total Stories**: 4 | **Total Points**: 13 | **MVP Stories**: 0 (roadmap — primary defect is Must Have)
...
Protect the artifacts the controller writes: the progress view and the commits it authors.
...
- **Cohort 1** (no cross-deps): 12.1-001, 12.2-001, 12.2-002 can run concurrently; 12.1-002
  shares files with 12.1-001, so serialize those two (or run 12.1-002 after 12.1-001).
