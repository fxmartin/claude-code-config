...
| Epic-19 | Controller UX & Ergonomics | Roadmap | 3 | 8 | P3 | **PLANNED** — small CLI + dashboard ergonomics fixes: multi-epic build scope (`sdlc build epic-15 epic-18`), a dashboard sidebar that distinguishes active runs from finished, and a live progress bar/counter that credits parallel stories as each finishes. Created 2026-06-25 |
